$(document).ready( function () {
    ...
    $('#addForm').submit(function(e) {
        ...
        $.ajax({
          url: "/admin/sale_unit_videos/add/",
          method: 'POST',
    ...
    $('#updForm').submit(function(e) {
        ...
        $.ajax({
          type: 'POST',
          url: "/admin/sale_unit_videos/update/",
          data: new FormData(this),
          contentType: false,
          processData: false,
          success: function (res) {
    ...
    $('#delForm').submit(function(e) {
        ...
        $.ajax({
          type: 'POST',
          url: "/admin/sale_unit_videos/delete/",
          data: $(this).serialize(),
          success: function (res) {
            alert(res.msg)
            get_all()
        ...
        success: function (res) {
            ...
            $.each(records, function(row, field) {
                ...
                var vid = `<video controls>
                            <source src='/uploads/sale_units/unit_videos/${field.video}'>
                           </video>`
                td_vid.append(vid)
                tr.append(td_vid)
...
function get_upd_id(id){
    ...
    $.ajax( {
      method:"POST",
      url:'/admin/sale_unit_videos/edit/',
      ...
      success: function(res) {
        ...
        $.each(records, function(row, field) {
            var option = $('<option>').text(field.unit_id).val(field.id)
            $('#upd_sale_unit_id').append(option)
        })
        $('#upd_sale_unit_id').val(record.sale_unit_id)
      }
    })
}
