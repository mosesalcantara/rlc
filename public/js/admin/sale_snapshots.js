$(document).ready( function () {
    ...
    $('#addModal').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            url: "/admin/sale_snapshots/get-related/",
            method: 'POST',
    ...
    $('#updForm').submit(function(e) {
        ...
        $.ajax({
          type: 'POST',
          url: "/admin/sale_snapshots/update/",
          data: new FormData(this),
          contentType: false,
          processData: false,
          success: function (res) {
    ...
    $('#delForm').submit(function(e) {
        ...
        $.ajax({
          type: 'POST',
          url: "/admin/sale_snapshots/delete/",
          data: $(this).serialize(),
          success: function (res) {
            alert(res.msg)
            get_all()
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $.each(records, function(row, field) {
                ...
                var img = $('<img>')
                img.attr({
                    'src' : `/uploads/sale_units/snapshots/${field.picture}`,
                })
                td_img.append(img)
                tr.append(td_img)
