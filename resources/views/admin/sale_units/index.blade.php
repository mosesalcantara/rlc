...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col mb-3">
                <h1 class="h3 mb-0 text-dark">Units For Sale</h1>
            </div>
        ...
        <div class="modal" tabindex="-1" id="addModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/sale/add" method="post" enctype="multipart/form-data" id="addForm">         
                        <div class="mb-3">
    ...
    <div class="container">
        <div class="modal" tabindex="-1" id="updModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/sale/update" method="post" enctype="multipart/form-data" id="updForm">
                        <div class="mb-3">
                            <label for="" class="form-label">Property</label>  
    ...
    <div class="container">
        <div class="modal" tabindex="-1" id="delModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/admin/sale/delete/" method="POST" id="delForm">
...
@section('scripts')
    ...
    <script src="{{ asset('js/admin/sale_units.js') }}"></script>
@endsection
