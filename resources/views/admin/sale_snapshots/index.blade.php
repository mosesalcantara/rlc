        ...
        <div class="modal" tabindex="-1" id="addModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/sale_snapshots/add" method="post" enctype="multipart/form-data" id="addForm">         
                        <div class="mb-3">
    ...
    <div class="container">
        <div class="modal" tabindex="-1" id="updModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/sale_snapshots/update" method="post" enctype="multipart/form-data" id="updForm">
                        <div class="mb-3">
                            <label for="" class="form-label">Picture</label>     
    ...
    <div class="container">
        <div class="modal" tabindex="-1" id="delModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/admin/sale_snapshots/delete/" method="POST" id="delForm">
...
@section('scripts')
    ...
    <script src="{{ asset('js/admin/sale_snapshots.js') }}"></script>
@endsection
