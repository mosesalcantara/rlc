$(document).ready( function () {
    ...
    $('#addModal').on('show.bs.modal', function(e) {
        ...
        $.ajax({
            url: "/admin/buildings/get-related",
            method: 'POST',
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $.each(records, function(row, field) {
                ...
                var img = $('<img>')
                img.attr({
                    'src' : `/uploads/buildings/floor_plans/${field.floor_plan}`,
                })
                td_img.append(img)
                tr.append(td_img)
