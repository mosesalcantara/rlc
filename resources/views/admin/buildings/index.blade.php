...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col mb-3">
                <h1 class="h3 mb-0 text-dark">Buildings</h1>
            </div>
        ...
        <div class="modal" tabindex="-1" id="addModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/buildings/add" method="post" enctype="multipart/form-data" id="addForm">         
                        <div class="mb-3">
    ...
    <div class="container">
        <div class="modal" tabindex="-1" id="updModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/buildings/update" method="post" enctype="multipart/form-data" id="updForm">
                        <div class="mb-3">
                            <label for="" class="form-label">Property</label>  
    ...
    <div class="container">
        <div class="modal" tabindex="-1" id="delModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h5>Are you sure you want to delete this Building?</h5>
                </div>
                <div class="modal-footer">
                    <form action="/admin/building/delete/" method="POST" id="delForm">
...
@section('scripts')
    ...
    <script src="{{ asset('js/admin/buildings.js') }}"></script>
@endsection
