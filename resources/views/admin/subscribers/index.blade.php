...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col mb-3">
                <h1 class="h3 mb-0 text-dark">Subscribers</h1>
            </div>
        ...
        <div class="modal" tabindex="-1" id="addModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/subscribers/add" method="post" enctype="multipart/form-data" id="addForm">    
                        <div class="row">
                            <div class="col">
    ...
    <div class="container">
        <div class="modal" tabindex="-1" id="updModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/subscribers/update" method="post" enctype="multipart/form-data" id="updForm">
                        <div class="row">
                            <div class="col">
                                <div class="form-floating mb-3">
    ...
    <div class="container">
        <div class="modal" tabindex="-1" id="delModal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="/admin/subscribers/delete/" method="POST" id="delForm">
...
@section('scripts')
    ...
    <script src="{{ asset('js/admin/subscribers.js') }}"></script>
@endsection
